...
public class PushDeal extends Fragment{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,@Nullable ViewGroup container,
        ...
        dealAddress.setText("31 Pioneer St. Waterloo");
        dealBusinessName.setText("Popular Pizza");
        dealCategory.setText("food");
        dealDescription.setText("35% off on new store opening\nFree delivery today");
        dealDiscount.setText("35");
        dealEmail.setText("popular.pizza@gmail.com");
        dealExpiry.setText("04-11-2022");
        dealPhone.setText("2233445566");
        dealTitle.setText("Popular Pizza");
//
