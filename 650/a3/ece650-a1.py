#print statements modified for assignment 3 - checked - working 6/3/2022
#!/usr/bin/env python
...
def getVerticesAndEdges(line_and_intersections):
    ...
    # printing for assignment 3
    # print("__________________________________________________")
    # print("vertex_list= {}".format(vertex_list))
    # print("")
    if (len(vertex_list)>0):
        print("V {}".format(len(vertex_list)), file=sys.stdout)
        sys.stdout.flush()
    ...
    #this part checks, if vertex list is not empty, the curly bracket has to be printed in nexxt line, otherwise in same
    # if not vertex_list:
    #     print('}', file=sys.stdout)
    # else:
    #     print('\n}', file=sys.stdout)
    ...
    #printing edges for assignment 3
    if (len(vertex_list)>0):
